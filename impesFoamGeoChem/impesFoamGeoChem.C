...
#include "argList.H"
#include "harmonic.H"
#include "twoPhaseGeochemicalModel.H"
...
Info << "About to call update() on porousMedia, pointer valid? " << porousMedia.pointerValid() << endl;
Info << "porousMedia address: " << &porousMedia << endl;


        porousMedia.update();
        #include "chemUpdate.H"
