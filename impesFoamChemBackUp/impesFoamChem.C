...
// At top of impesFoamChem.C (outside any function)
Foam::List<Foam::scalar> ZCI_global;
Foam::scalar T_global;
Foam::scalar p_global;
Foam::scalar R_global;
...
//    #include "readEvent.H"
  ...
  //      #include "computeSourceTerm.H"
		...
		//- Solve the thermodynamics and update saturations before we proceed!
        #include "YEqn.H"
